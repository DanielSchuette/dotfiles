...
import { CancellationToken, Disposable, DocumentSelector } from 'vscode-languageserver-protocol';
...
export declare class ServiceManager extends EventEmitter implements Disposable {
    ...
    sendRequest(id: string, method: string, params?: any, token?: CancellationToken): Promise<any>;
