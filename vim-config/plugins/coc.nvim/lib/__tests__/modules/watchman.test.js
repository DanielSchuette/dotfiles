...
describe('watchman', () => {
    ...
    it('should subscribe', async () => {
        ...
        sendSubscription(global.subscribe, cwd, changes);
        await wait(100);
...
describe('Watchman#createClient', () => {
    it('should create client', async () => {
        let client = await watchman_1.default.createClient(null, process.cwd());
    ...
    it('should resue client for same root', async () => {
        let client = await watchman_1.default.createClient(null, process.cwd());
        expect(client).toBeDefined();
        let other = await watchman_1.default.createClient(null, process.cwd());
