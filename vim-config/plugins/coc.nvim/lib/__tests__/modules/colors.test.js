...
beforeAll(async () => {
    ...
    disposables.push(languages_1.default.registerDocumentColorProvider([{ language: '*' }], {
        provideColorPresentations: (_color, _context, _token) => [vscode_languageserver_protocol_1.ColorPresentation.create('red'), vscode_languageserver_protocol_1.ColorPresentation.create('#ff0000')],
