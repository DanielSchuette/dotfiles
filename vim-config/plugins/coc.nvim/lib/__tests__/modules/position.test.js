...
describe('Position', () => {
    ...
    test('rangeOverlap', () => {
        ...
        expect(position_1.rangeOverlap(r, vscode_languageserver_types_1.Range.create(0, 0, 0, 0))).toBe(false);
        ...
        expect(position_1.rangeOverlap(vscode_languageserver_types_1.Range.create(0, 0, 0, 1), vscode_languageserver_types_1.Range.create(0, 1, 0, 2))).toBe(false);
        expect(position_1.rangeOverlap(vscode_languageserver_types_1.Range.create(0, 1, 0, 2), vscode_languageserver_types_1.Range.create(0, 0, 0, 1))).toBe(false);
