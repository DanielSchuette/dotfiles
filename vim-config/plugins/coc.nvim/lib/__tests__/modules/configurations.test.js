...
const workspaceConfigFile = path_1.default.resolve(__dirname, `../sample/.vim/${util_2.CONFIG_FILE_NAME}`);
...
describe('Configurations', () => {
    ...
    it('should handle errors', () => {
        let tmpFile = path_1.default.join(os_1.default.tmpdir(), uuid_1.v1());
