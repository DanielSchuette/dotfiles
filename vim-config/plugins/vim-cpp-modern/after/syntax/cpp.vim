...
" NOTE(daniel): I added these to make template "preambles" look more uniform
syntax keyword cppConceptCustom concept requires
hi def link cppConceptCustom cppStructure
